...
//store into database
            $pass=md5($pass1);
            $status=mysqli_query($conn,"insert into users(uname,uemail,umobile,upassword,utype) values('$uname','$uemail','$umobile','$pass','customer')");
            if($status){
...
<head>
    ...
    <title>Register|SuperMart|Elecrtronic,fashion,sports,books available </title>
...
<body>
    ...
    <p class="fs-6 fw-bold mb-0 py-1 px-0 px-md-2 bg-warning" style="color: #130f40;">WELCOME TO SUPERMART</p>
        <div class="icons mx-2">
            <a class="text-decoration-none fw-bold" href="cuslogin.php"><img src=" ../img/windo/register.png" alt="" >Login</a>
   ...
   <div class="container" id="login">
    <form action="" method="post" ><div class="row">
        ...
        <div class="col-md-7 py-3 py-md-0" id="side2">
            ...
            <p class="text-center fw-bold mt-3">Already have an Acoount?<a href="cuslogin.php">Click Here</a></p>
